<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"  class="h-lvh">
    <head>
        <meta charset="utf-8">
...
<body class="antialiased flex flex-col h-lvh bg-gray-50 dark:bg-slate-900" id="app">
...
<div class="flex justify-content-end bg-white ">
<footer class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto ">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-5 text-center">
    ...
    <ul class="text-center">
      ...
      <li class="inline-block relative pe-8 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-3 before:-translate-y-1/2 before:content-['/'] before:text-gray-300 dark:before:text-gray-600">
        <a href=" {{ url('/shipping') }}" class="inline-flex gap-x-2 text-sm text-gray-500 hover:text-gray-800 dark:text-gray-500 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
          shipping
        </a>
      </li>
    </ul>
